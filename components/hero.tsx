		...
		<section id="hero">
			<div className="relative flex flex-col items-center justify-center gap-5 px-4 py-12 md:px-4 md:py-24 lg:py-28">
				...
				>
					...
					<span className="text-xs">Analytics dashboard now available</span>
					<span className="block h-5 border-l" />

					<div className="pr-1">
						<RiArrowRightLine className="size-3 -translate-x-0.5 duration-150 ease-out group-hover:translate-x-0.5" />
					</div>
				</a>
				...
				>
					Create short, memorable links in seconds. <br /> Track clicks, analyze performance, and grow your audience.
				</p>
